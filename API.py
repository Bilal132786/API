...
\x1b[1;97m─────────────────────────
\x1b[1;97mMR BILAL :\x1b[1;92mbillu XD 
\x1b[1;92mNo Whatsap :\x1b[1;97m03190857715
...
def dump_massal():
	...
	for met in range(jum):
		yz+=1
		kl = input('|𝐌𝐚𝐬𝐮𝐤𝐚𝐧 𝐈𝐝𝐳 𝐘𝐚𝐧𝐠 𝐊𝐞 : '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
	...
	try:
		print('')
		print(f'|𝐓𝐨𝐭𝐚𝐥 𝐈𝐝𝐳 𝐘𝐚𝐧𝐠 𝐓𝐞𝐫𝐤𝐮𝐦𝐩𝐮𝐥 : {h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
...
def setting():
	...
	if hc in ['1','01']:
		...
		method.append('mobile')
	print('')
	_jembot_ = input('|𝐓𝐚𝐦𝐛𝐚𝐡𝐤𝐚𝐧 𝐀𝐩𝐥𝐢𝐤𝐚𝐬𝐢 (𝐍𝐨𝐭 𝐑𝐞𝐜𝐨𝐦𝐦𝐞𝐧𝐝) [𝐘/𝐭] : ')
	if _jembot_ in ['']:
		print('>> Pilih Yang Bener Kontol ')
		back()
